...
void DEBUG_reset()
{
	...
	// Force a reference to the member function without attempting to print its address.
	// Pointer-to-member types are not regular pointers and cannot be portably printed with %p.
	(void)&DebugStatistics::print;

	// Simple, safe log message
	printf("DEBUG_reset\n");
}
